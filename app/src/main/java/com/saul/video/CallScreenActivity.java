...
//        });
    ...
    private void updateUI() {
        ...
        Call call = getSinchServiceInterface().getCall(mCallId);
        if (call != null) {
            mCallerName.setText(getString(R.string.doctor_label)/*call.getRemoteUserId()*/);
...
//            String endMsg = "Call ended: " + call.getDetails().toString();
            Toast.makeText(CallScreenActivity.this, getString(R.string.call_ended), Toast.LENGTH_LONG).show();
